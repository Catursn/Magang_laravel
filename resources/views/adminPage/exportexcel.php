...
<body>
	...
	header("Content-Disposition: attachment; filename=E-recruitment.xls");
	?>
 
	<center>
		<h1>Export Data Ke Excel Dengan PHP <br/> www.garudapratama.com</h1>
	</center>
	...
	<table border="1">
		...
		$data = mysqli_query($koneksi,"select * from excel_form");
		$no = 1;
